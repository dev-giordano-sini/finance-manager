...
public class UserEntity extends JpaBaseEntity {
    ...
    @ManyToOne(fetch = FetchType.LAZY, optional = false) @JoinColumn(name = "role_id") public RoleEntity role;
    protected UserEntity() {}
    public UserEntity(String e, String p, String n, String s, RoleEntity r) {
        email = e;
        password = p;
        name = n;
        surname = s;
