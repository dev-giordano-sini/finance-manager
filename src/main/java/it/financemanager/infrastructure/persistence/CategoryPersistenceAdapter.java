...
class CategoryPersistenceAdapter implements CategoryStore {
  ...
  CategoryPersistenceAdapter(JpaCategoryRepository r, JpaUserRepository u) {
    repository = r;
    users = u;
  }
  ...
  public Category saveAndFlush(Category v) {
    try {
      CategoryJpaEntity e = v.getId() == null
  ...
  public void delete(Category v) { repository.deleteById(v.getId()); }
  public void flush() {
    try {
      repository.flush();
    } catch (DataIntegrityViolationException ex) {
