...
class JwtAccessTokenAdapter implements AccessTokenIssuer {
    ...
    @Override public String issue(String subject) { return jwtService.generate(subject); }
    @Override public long expiresInSeconds() { return jwtService.expiresInSeconds(); }
}
