...
public class BudgetService {
 private final BudgetOutputPort repository; private final CategoryService categories; private final CurrentUserService currentUser;
 public BudgetService(BudgetOutputPort repository,CategoryService categories,CurrentUserService currentUser){this.repository=repository;this.categories=categories;this.currentUser=currentUser;}
