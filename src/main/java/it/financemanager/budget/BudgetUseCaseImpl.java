...
public class BudgetUseCaseImpl implements BudgetUseCase {
 private final BudgetRepository repository; private final CategoryUseCase categories; private final CurrentUserUseCase currentUser;
 public BudgetUseCaseImpl(BudgetRepository repository,CategoryUseCase categories,CurrentUserUseCase currentUser){this.repository=repository;this.categories=categories;this.currentUser=currentUser;}
