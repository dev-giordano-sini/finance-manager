...
import it.financemanager.user.UserRepositoryPort;
...
public class AuthService {
    ...
    public AuthService(UserRepositoryPort users, PasswordEncoder passwordEncoder, AuthenticationManager authenticationManager, JwtService jwt, RoleService roleService) {
